...
export default function HomeDashboard() {
  ...
  const calcularTotalItem = (item) => {
    ...
    if (item.adicionais.length > 0) {
      somaAdicionais = item.adicionais.reduce(
        (total, adicional) =>
          total + adicional.valor * adicional.qtde,
        0
      );
  ...
  const formatarDadosItemEntregador = (item) => {
    ...
    if (item.adicionais.length > 0) {
      ...
      conteudo += `<br/>Total do item (a + b + c): ${useFormat(
        somaTotalItem
      )}`;
    } else {
  ...
  const formatarDadosCompleto = (pedido) => {
    ...
    if (
      troco &&
      (troco === 0 || troco === '0' || troco.includes('R$'))
    ) {
      trocoDaCompra = `
          Troco: ${troco}<br/>
          ---------------------------------------<br/>
                        ...
                        pedido.itens.map(
                          (item, itemIndex) => (
                            ...
                            >
                              ...
                              R${' '}
                              {item.valorTotalDoProduto.toFixed(
                                2
                              )}
                              <br />
                            </Typography>
